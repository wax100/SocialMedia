	...
	class SocialMedia {
        ...
        */
        ...
        /**
            ...
            * @return Array.
        */
        public function getCriteriaAccess() {
            $contextKeys = array();
            $query = $this->modx->newQuery('modAccessContext', array('target:NOT IN' => array('web', 'mgr')));
            $query->leftJoin('modUserGroupMember', 'modUserGroupMember', 'modUserGroupMember.user_group = modAccessContext.principal');
            $query->leftJoin('modContextSetting', 'modContextSetting', 'modContextSetting.context_key = modAccessContext.target');
            $query->select($this->modx->getSelectColumns('modContextSetting', 'modContextSetting', '', array('value')));
            $query->where(array('modUserGroupMember.member' => $this->modx->user->id, 'modContextSetting.key' =>'socialmedia.criterea'));
