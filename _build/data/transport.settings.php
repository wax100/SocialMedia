<?php
    ...
    $settings[1]->fromArray(array(
        ...
        'value' 	=> '//www.werkvanoetzie.nl/extras/socialmedia',
        'xtype' 	=> 'textfield',
        'namespace' => PKG_NAME_LOWER,
        'area' 		=> PKG_NAME_LOWER
    ), '', true, true);
	...
	$settings[32] = $modx->newObject('modSystemSetting');
	$settings[32]->fromArray(array(
	...
	$settings[33] = $modx->newObject('modSystemSetting');
	$settings[33]->fromArray(array(
